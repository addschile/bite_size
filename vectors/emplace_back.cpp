...
int main() {
    ...
    std::cout << "doing push_back\n";
    mats.push_back(ones<double>(3,3));
    std::cout << "\ndoing emplace_back\n";
    mats.emplace_back(ones<double>(3,3));
    std::cout << "\ndoing empty push_back\n";
    mats.push_back(Matrix<double>{});
    std::cout << "\ndoing empty emplace_back\n";
    mats.emplace_back();
